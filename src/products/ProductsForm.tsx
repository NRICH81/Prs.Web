...
const emptyProducts: IProduct = {vendor: undefined, id: undefined, price: undefined, vendorId: undefined, name: "",
  partNumber: "", unit: "",
};
...
function ProductsForm() {
  ...
  const save: SubmitHandler<IProduct> = async (products) => {
    try {
      delete products.vendor;               
      if (!products.id) await productAPI.post(products);   
      else await productAPI.put(products);                
    } catch (error: unknown) {
